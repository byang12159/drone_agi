...
pf = pd.read_csv(fn2)
fn3 = os.path.join(script_dir, 'exp_08-19-11-32.csv')
...
fn7 = os.path.join(script_dir, 'exp_08-19-11-32.xcp')
xcp = open(fn7, 'r')
xcpstring = xcp.read()
...
plt.plot(vicon_ts, vicon_data[:,4], label='vicon_pos')
...
plt.plot(pf_ts, pf_data[:,1], label='pf_pos')
