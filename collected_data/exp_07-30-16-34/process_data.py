...
plt.figure(3)
plt.plot(ctrl_ts[1:], (ctrl_data[1:,5]-ctrl_data[:-1,5])/(ctrl_ts[1:]-ctrl_ts[:-1]), label='finite diff v')
# plt.plot(agivel_ts, agivel_data[:,0])
# plt.plot([1722375434.4892318,1722375434.4892318],[0,3],'b')
plt.figure(4)
plt.plot(ctrl_ts[1:], (ctrl_data[1:,6]-ctrl_data[:-1,6])/(ctrl_ts[1:]-ctrl_ts[:-1]), label='finite diff v')
# plt.plot(agivel_ts, agivel_data[:,1])
# plt.plot([1722375434.4892318,1722375434.4892318],[0,3],'b')
plt.figure(5)
plt.plot(ctrl_ts[1:], (ctrl_data[1:,7]-ctrl_data[:-1,7])/(ctrl_ts[1:]-ctrl_ts[:-1]), label='finite diff v')
