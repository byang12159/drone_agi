...
# Note calibrateCamera function calcualtes the intrinsic paramersts again, may just remove
...
class StereoCalibration(object):
    def __init__(self):
        ...
        self.objp = np.zeros((intersections_x*intersections_y, 3), np.float32)
        self.objp[:, :2] = np.mgrid[0:intersections_y, 0:intersections_x].T.reshape(-1, 2)
    ...
    def read_images(self, cal_path):
        ...
        for i, fname in enumerate(images_right):
            ...
            ret_l, corners_l = cv2.findChessboardCorners(gray_l, (intersections_y, intersections_x), None)
            ret_r, corners_r = cv2.findChessboardCorners(gray_r, (intersections_y, intersections_x), None)
            ...
            if ret_l is True:
                ...
                ret_l = cv2.drawChessboardCorners(img_l, (intersections_y, intersections_x),
                                                  corners_l, ret_l)
            ...
            if ret_r is True:
                ...
                # Draw and display the corners
                ret_r = cv2.drawChessboardCorners(img_r, (intersections_y, intersections_x),
                                                  corners_r, ret_r)
